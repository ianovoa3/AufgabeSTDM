...
public class Tabelle extends javax.swing.JFrame {
    ...
    public Tabelle() {
        ...
        try{
            loadTableData();
             ...
             Logger.getLogger(Tabelle.class.getName()).log(Level.SEVERE, null, e);
        }
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       NeuePerson person = new NeuePerson();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tabelle.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
